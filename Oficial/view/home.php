...
<div class="row">
  <div class="col-lg-4">
    <img class="rounded-circle" src="img/manu.jpg" alt="Generic placeholder image" width="140" height="140">
    <h2><a class="texc" style="color: black">Manutenção</a></h2>
    <p class="bb"></p>
    <p><a class="btn btn-secondary" href="#" role="button">Agendar</a></p>
  </div>
  <div class="col-lg-4">
    <img class="rounded-circle" src="img/sus.jpg" lt="Generic placeholder image" width="140" height="140">
    <h2><a class="texc" style="color: black">Suspensão</a></h2>
    <p class="bb"></p>
    <p><a class="btn btn-secondary" href="#" role="button">Agendar</a></p>
  </div>
  <div class="col-lg-4">
    <img class="rounded-circle" src="img/motor.jpg" alt="Generic placeholder image" width="140" height="140">
    <h2><a class="texc" style="color: black">Motor</a></h2>
    <p class="bb"></p>
    <p><a class="btn btn-secondary" href="#" role="button">Agendar</a></p>
  </div>
  <div class="col-lg-4">
    <img class="rounded-circle" src="img/alinha.jpg" alt="Generic placeholder image" width="140" height="140">
    <h2><a class="a" style="color: black">Alinhamento e Balanceamento</a></h2>
    <p class="bb"></p>
    <p><a class="btn btn-secondary" href="#" role="button">Agendar</a></p>
  </div>
  <div class="col-lg-4">
     <img class="rounded-circle" src="img/pneu.jpg" alt="Generic placeholder image" width="140" height="140">
    <h2><a class="texc" style="color: black">Troca De Pneus</a></h2>
    <p class="bb"></p>
    <p><a class="btn btn-secondary" href="#" role="button">Agendar</a></p>
  </div>
  <div class="col-lg-4">
      <img class="rounded-circle" src="img/poli.jpg" alt="Generic placeholder image" width="140" height="140">
      <h2><a class="texc" style="color: black">Polimento</a></h2>
      <p class="bb"></p>
      <p><a class="btn btn-secondary" href="#" role="button">Agendar</a></p>
    </div>
</div>
      ...
      <div class="card-deck mb-3 text-center">
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-lg btn-block btn-outline-primary"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Inscreva-se grátis</font></font></button>
          </div>
        </div>
        <div class="card mb-4 box-shadow">
          <div class="card-header">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              ...
              <li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Suporte prioritário por email</font></font></li>
              <li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Acesso ao Centro de Ajuda</font></font></li>
            </ul>
        ...
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              ...
              <li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Suporte por telefone e email</font></font></li>
              <li><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Acesso ao Centro de Ajuda</font></font></li>
            </ul>
